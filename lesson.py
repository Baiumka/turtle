#1.Создать два финиша
#2.Добавить 2 противника, которые будут ездить по вертикали
#3.Добавить еще одного игрока (на стрелочках)
#4*.Сделать  так, что бы при победе или поражении игра не продолжалась, а полностью останавливалась.
